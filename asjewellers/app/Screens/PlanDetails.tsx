...
export default function PlanDetails() {
  ...
  const { planId } = route.params; // Get the plan ID from navigation params
  ...
  const bonusAmountRs = 4500; // You might want to calculate this based on your business logic
