...
const handleSignOutConfirm = async () => {
  ...
  try {
    ...
    if (result?.ok) {
      // Wait for all state updates before navigating
      setSigningOut(false);
    ...
    <>
      <ScrollView style={styles.container}>
        ...
        <View style={styles.profileCard}>
          ...
          <Text style={styles.phone}>{profile?.phone || '1234567890'}</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoCard}>
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoValue}>{profile?.phone || '1234567890'}</Text>
            </View>
          </View>
