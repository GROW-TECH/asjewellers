                    ...
                    children: [
                      {
                        ...
                        phone_number: '9876543551',
                        referral_code: 'REF555551',
                        created_at: new Date().toISOString(),
                        level: 5,
                        directReferrals: 1,
                        children: [
                          {
                            ...
                            full_name: 'Uma Allen',
                            phone_number: '9876543661',
                            referral_code: 'REF666661',
                            created_at: new Date().toISOString(),
                            level: 6,
                            directReferrals: 1,
                            children: [
                              {
                                ...
                                phone_number: '9876543771',
                                referral_code: 'REF777771',
                                created_at: new Date().toISOString(),
                                level: 7,
                                directReferrals: 1,
                                children: [
                                  {
                                    ...
                                    phone_number: '9876543881',
                                    referral_code: 'REF888881',
                                    created_at: new Date().toISOString(),
                                    level: 8,
                                    directReferrals: 1,
                                    children: [
                                      {
                                        ...
                                        phone_number: '9876543991',
                                        referral_code: 'REF999991',
                                        created_at: new Date().toISOString(),
                                        level: 9,
                                        directReferrals: 1,
                                        children: [
                                          {
                                            ...
                                            phone_number: '9876543aa1',
                                            referral_code: 'REFaaaaaa',
                                            created_at: new Date().toISOString(),
                                            level: 10,
                                            directReferrals: 0,
                                            children: [],
                ...
                children: [
                  {
                    ...
                    phone_number: '9876543442',
                    referral_code: 'REF444442',
                    created_at: new Date().toISOString(),
                    level: 4,
                    directReferrals: 1,
                    children: [
                      {
                        ...
                        phone_number: '9876543552',
                        referral_code: 'REF555552',
                        created_at: new Date().toISOString(),
                        level: 5,
                        directReferrals: 1,
                        children: [
                          {
                            ...
                            phone_number: '9876543662',
                            referral_code: 'REF666662',
                            created_at: new Date().toISOString(),
                            level: 6,
                            directReferrals: 1,
                            children: [
                              {
                                ...
                                phone_number: '9876543772',
                                referral_code: 'REF777772',
                                created_at: new Date().toISOString(),
                                level: 7,
                                directReferrals: 1,
                                children: [
                                  {
                                    ...
                                    phone_number: '9876543882',
                                    referral_code: 'REF888882',
                                    created_at: new Date().toISOString(),
                                    level: 8,
                                    directReferrals: 1,
                                    children: [
                                      {
                                        ...
                                        phone_number: '9876543992',
                                        referral_code: 'REF999992',
                                        created_at: new Date().toISOString(),
                                        level: 9,
                                        directReferrals: 1,
                                        children: [
                                          {
                                            ...
                                            phone_number: '9876543bb1',
                                            referral_code: 'REFbbbbbb',
                                            created_at: new Date().toISOString(),
                                            level: 10,
                                            directReferrals: 0,
                                            children: [],
            ...
            children: [
              {
                ...
                phone_number: '9876543334',
                referral_code: 'REF333334',
                created_at: new Date().toISOString(),
                level: 3,
                directReferrals: 0,
                children: [],
              },
              {
                ...
                phone_number: '9876543335',
                referral_code: 'REF333335',
                created_at: new Date().toISOString(),
                level: 3,
                directReferrals: 0,
                children: [],
